...
SPEC = ToolSpec(
    ...
    description=(
        ...
        "✓ Adapted scene from different room (MUST save for this room if successful)\n"
        ...
        "✓ Tool: {\"type\":\"tool_call\",\"tool\":\"search_spotify\",\"args\":{...}} (only sequence-safe tools)\n"
        "✓ Guards: Add only_if_state to skip steps (state/attribute checks, see run_sequence)\n\n"
