...
SPEC = ToolSpec(
    ...
    description=(
        ...
        "ALWAYS use for final answers. Pass NATURAL TEXT that sounds good spoken aloud.\n\n"
        "WHAT TO PASS IN (content parameter):\n"
        "✓ Natural sentences: 'Now playing Seinfeld in the gym'\n"
        "✓ Results + context: 'I turned on 12 office lights to 80% brightness'\n"
        "✓ What happened: 'Playing the latest SNL episode from your library - Season 27'\n"
        "✗ NO internal thoughts: 'Reflection: searched scene (done)...'\n"
        "✗ NO confidence scores: 'Confidence: 85%'\n"
        "✗ NO tool steps: 'Called search_devices, then control_device...'\n"
        "✗ NO bullet lists or technical recaps\n\n"
        "STYLES:\n"
        "- 'brief': 1-2 sentences summarizing result\n"
