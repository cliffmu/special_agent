...
async def build_system_prompt(
    ...
    system_prompt = (
        ...
        "FAST PATH (Guideline, not strict):\n"
        "- Loop 1: gather candidates and any missing IDs in parallel; ask once only if a critical detail is unknown\n"
        "- Loop 2: choose one plan and execute exactly once; on success, speak the prepared line\n"
