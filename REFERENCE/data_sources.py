...
# Weather-related functions have been moved to the weather.py module
# These import statements exist to maintain backward compatibility
# New code should import directly from the weather module
